  ...
  <div class="col-xxl">
    <div class="card mb-4">
      <div class="card-body">
        ...
        {{-- End Message --}}
        {!! Form::model($motorbikes, ['method' => 'put','route' => ['motorbikes.soldStolenContract', $motorbikes->motorID]]) !!}
        @csrf
          <div class="row mb-3">
            {!! Form::hidden('motorID', null, array('class' => 'form-control')) !!}
          ...
          <div class="row mb-3">
            ...
            <div class="input-group">
              <span class="input-group-text">Motorbike No.</span>
                {!! Form::text('motorno', null, array('class' => 'form-control', 'readonly' => 'true')) !!}
            </div>
          </div>
          <div class="row mb-3">
            ...
            {!! Form::date('returnDate', null, array('class' => 'form-control')) !!}
            </div>
          </div>
          <div class="row mb-3">
