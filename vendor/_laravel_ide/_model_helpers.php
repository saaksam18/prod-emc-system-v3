...
namespace App\Models {
     ...
     * @property mixed $en_short_name
     * @property mixed $alpha_3_code
     * @property mixed $alpha_2_code
     * @property int $num_code
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<CountriesModel>|CountriesModel whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CountriesModel>|CountriesModel whereNumCode($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CountriesModel>|CountriesModel whereAlpha2Code($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CountriesModel>|CountriesModel whereAlpha3Code($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CountriesModel>|CountriesModel whereEnShortName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CountriesModel>|CountriesModel whereNationality($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CountriesModel>|CountriesModel whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CountriesModel>|CountriesModel whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CountriesModel>|CountriesModel newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CountriesModel>|CountriesModel newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CountriesModel>|CountriesModel query()
     ...
     */
    class CountriesModel extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\MotorbikeInfo
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property int $userID
     ...
     * @property int|null $totalPurchasePrice
     * @property int|null $compensationPrice
     * @property bool|null $motorStatus
     * @property string|null $purchaseDate
     * @property mixed $motorModel
     * @property mixed $motorType
     * @property mixed $motorColor
     * @property mixed $chassisNo
     * @property mixed $engineNo
     * @property mixed $plateNo
     * @property mixed $year
     * @property int $motorno
     * @property int $motorID
     * @property-read \App\Models\User $user
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereMotorid($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereMotorno($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereYear($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo wherePlateno($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereEngineno($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereChassisno($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereMotorcolor($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereMotortype($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereMotormodel($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo wherePurchasedate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereMotorstatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereCompensationprice($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereTotalpurchaseprice($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereCustomerid($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereIsActive($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereUserid($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo sortable()
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MotorbikeInfo>|MotorbikeInfo query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class MotorbikeInfo extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User sortable()
